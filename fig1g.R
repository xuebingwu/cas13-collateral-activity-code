...
# load fig1g data, n=3 biological replicates
x=read.csv("./fig1g.csv",row.name=1)
...
KDg3  <- apply(x[,1:3],1,mean) # DsRed KD
NTg11 <- apply(x[,4:6],1,mean) # Control


pdf("fig1g.pdf",width=4,height=4)
par(pty="s")
